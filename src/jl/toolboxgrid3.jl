...
"""
    toolboxgrid3(;kwargs...)
    toolboxgrid3(children::Any;kwargs...)
    toolboxgrid3(children_maker::Function;kwargs...)
...
function toolboxgrid3(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("toolboxgrid3", "ToolBoxGrid3", "dash_drag_grid", available_props, wild_props; kwargs...)
end

toolboxgrid3(children::Any; kwargs...) = toolboxgrid3(;kwargs..., children = children)
toolboxgrid3(children_maker::Function; kwargs...) = toolboxgrid3(children_maker(); kwargs...)
