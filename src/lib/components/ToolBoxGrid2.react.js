...
import {categorizeContent, filterLayoutForToolboxItems} from '../utils';
...
const ToolBoxGrid2 = (props) => {
    ...
    const handleDrop = (layout, layoutItem, _event) => {
        ...
        const newItem = {
            ...
            x: newX,
            y: newY,
            w: calculateDimension(limit.x - newX, prevState.onDropWidth),
            h: calculateDimension(limit.y - newY, prevState.onDropHeight),
            inToolbox: false,
        };
